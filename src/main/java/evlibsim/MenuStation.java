    ...
    static Menu createStationMenu() {
        ...
        newChargingStationMI.setOnAction((ActionEvent e) -> {
            ...
            if (energyUnit.getSelectionModel().getSelectedIndex() == 0) {
                cb1.setItems(FXCollections.observableArrayList("122000 W", "50000 W", "43000 W"));
                EVLibSim.grid.add(cb1, 3, 5);
                cb2.setItems(FXCollections.observableArrayList("22000 W", "11000 W", "7000 W", "3000 W"));
                EVLibSim.grid.add(cb2, 1, 6);
                cb3.setItems(FXCollections.observableArrayList("50000 W", "22000 W", "7000 W"));
                EVLibSim.grid.add(cb3, 3, 6);
                cb4.setItems(FXCollections.observableArrayList("7000 W", "3600 W"));
                EVLibSim.grid.add(cb4, 1, 7);
            } else {
                cb1.setItems(FXCollections.observableArrayList("122 kW", "50 kW", "43 KW"));
                EVLibSim.grid.add(cb1, 3, 5);
                cb2.setItems(FXCollections.observableArrayList("22 kW", "11 KW", "7 kW", "3 kW"));
                EVLibSim.grid.add(cb2, 1, 6);
                cb3.setItems(FXCollections.observableArrayList("50 kW", "22 kW", "7 kW"));
                EVLibSim.grid.add(cb3, 3, 6);
                cb4.setItems(FXCollections.observableArrayList("7 kW", "3.6 kW"));
                EVLibSim.grid.add(cb4, 1, 7);
            }
        ...
        allChargersMI.setOnAction(e -> {
            ...
            TableColumn<Charger, Number> idCol = new TableColumn<>("Id");
        ...
        allDisChargersMI.setOnAction(e -> {
            ...
            TableColumn<DisCharger, Number> idCol = new TableColumn<>("Id");
        ...
        allExchangeHandlersMI.setOnAction(e -> {
            ...
            TableColumn<ExchangeHandler, Number> idCol = new TableColumn<>("Id");
        ...
        allParkingSlotsMI.setOnAction(e -> {
            ...
            TableColumn<ParkingSlot, Number> idCol = new TableColumn<>("Id");
        ...
        allBatteriesMI.setOnAction(e -> {
            ...
            TableColumn<Battery, Number> idCol = new TableColumn<>("Id");
            ...
            TableColumn<Battery, Number> numberOfChargingsCol = new TableColumn<>("Chargings");
            TableColumn<Battery, Number> maxNumberOfChargings = new TableColumn<>("MaximumChargings");
            ...
            numberOfChargingsCol.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getNumberOfChargings()));
            maxNumberOfChargings.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getMaxNumberOfChargings()));
            table.setItems(result);
            root.setCenter(table);
        });
